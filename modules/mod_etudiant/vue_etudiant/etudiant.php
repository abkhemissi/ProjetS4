        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 card-body">
                    <a id="boutonModif" class=" btn optionMenu " href="index.php?module=etudiant&action=formModifEtud&numeroINE=<?=$donnees['numeroINE']?>"  ><img src="bootstrap-icons/icons/pencil.svg" alt="+" width="32" height="32" title="Plus"> </a>
                </div>
                <div class="col-xs-1 col-sm-1 col-md-1 col-lg-1 card-body">
                ...
                <?php if($idGroupe == 0){
                    ...
                    echo '<a class=" btn optionMenu " href="index.php?module=etudiant&action=suppEtudiant&numeroINE='.$donnees['numeroINE'].'&idGroupe='.$idGroupe.'" ><img  src="bootstrap-icons/icons/trash-fill.svg" alt="+" width="32" height="32" title="Plus"> </a>supprimer du groupe';
                }
                ?>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <div id="divModal1">
                            ...
                            <p class="divModal1P">Numero INE : <?=$donnees['numeroINE']?></p>
                        </div>
